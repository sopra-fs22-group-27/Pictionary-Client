...
//      const user = new User(response.data);
  ...
  content = (
	...
	<div className="profile field">
		<div className="profile paragraph"><p>Get user {user.id} from secure endpoint:</p><span>Welcome User {myid}:</span><span>You are inspecting User {user.id} Profile</span></div>
	</div>
	<div>
	...
	<div className="profile field">
		...
		<input type="text" className="profile input" value={user.status==="ONLINE"?'ONLINE':'OFFLINE'} disabled/>
	</div>
